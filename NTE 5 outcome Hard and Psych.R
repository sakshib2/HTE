...
ggplot(combined_ate_estimates) +
  ...
  geom_errorbar(aes(x = Ntile, ymax = Estimate + 1.96 * SE, ymin = Estimate - 1.96 * SE, color = Method), 
                ...
                position = position_dodge(width = .5)) +
  theme_linedraw() +
  labs(x = "N-tile", y = "ATE Estimate", title = "ATE within N-tiles e_monthly_profits_all.3 (as defined by predicted CATE)")
...
ggplot(combined_ate_estimates) +
  ...
  geom_errorbar(aes(x = Ntile, ymax = Estimate + 1.96 * SE, ymin = Estimate - 1.96 * SE, color = Method), 
                ...
                position = position_dodge(width = .5)) +
  theme_linedraw() +
  labs(x = "N-tile", y = "ATE Estimate", title = "ATE within N-tiles e_monthly_revenue_all.3 (as defined by predicted CATE)")
...
ggplot(combined_ate_estimates) +
  ...
  geom_errorbar(aes(x = Ntile, ymax = Estimate + 1.96 * SE, ymin = Estimate - 1.96 * SE, color = Method), 
                ...
                position = position_dodge(width = .5)) +
  theme_linedraw() +
  labs(x = "N-tile", y = "ATE Estimate", title = "ATE within N-tiles e_monthly_expenses_all.3 (as defined by predicted CATE)")
...
ggplot(combined_ate_estimates) +
  ...
  geom_errorbar(aes(x = Ntile, ymax = Estimate + 1.96 * SE, ymin = Estimate - 1.96 * SE, color = Method), 
                ...
                position = position_dodge(width = .5)) +
  theme_linedraw() +
  labs(x = "N-tile", y = "ATE Estimate", title = "ATE within N-tiles e_wagebill_all.3 (as defined by predicted CATE)")
...
ggplot(combined_ate_estimates) +
  ...
  geom_errorbar(aes(x = Ntile, ymax = Estimate + 1.96 * SE, ymin = Estimate - 1.96 * SE, color = Method), 
                ...
                position = position_dodge(width = .5)) +
  theme_linedraw() +
  labs(x = "N-tile", y = "ATE Estimate", title = "ATE within N-tiles e_hh_consumption.3 (as defined by predicted CATE)")
